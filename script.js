...
function getStateParks(baseUrl, stateArr, maxResults, apiKey) {
    ...
    .catch(err => {
        $('.js-error').text(`Uh-oh, something went wrong: ${err.message}`);
    });
}
...
function watchForm() {
    $('.js-form').on('submit', function() {
        ...
        getStateParks(baseUrl, stateArr, maxResults, apiKey);
    })
}
